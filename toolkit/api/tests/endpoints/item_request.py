...
class ItemsRequestDocumentTest(BaseEndpointTest):
    ...
    @property
    def endpoint(self):
        return reverse('matter_item_request_doc', kwargs={'matter_slug': self.workspace.slug})

    def test_endpoint_name(self):
        self.assertEqual(self.endpoint, '/api/v1/matters/lawpal-test/items/request_document')
    ...
    def test_lawyer_get(self):
        ...
        self.assertTrue(UserSerializer(self.user).data.get('url') in json_data['results'][0]['responsible_party'])
