...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExportedMatter'
        db.create_table(u'matter_exportedmatter', (
            ...
            ('token', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal(u'matter', ['ExportedMatter'])


    def backwards(self, orm):
        # Deleting model 'ExportedMatter'
        db.delete_table(u'matter_exportedmatter')
    ...
    models = {
        ...
        u'matter.exportedmatter': {
            'Meta': {'object_name': 'ExportedMatter'},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'matter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['workspace.Workspace']"}),
            'token': ('django.db.models.fields.SlugField', [], {'max_length': '50'})
        },
        u'workspace.tool': {
