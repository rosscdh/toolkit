...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'discussion_discussioncomment', (
            (u'threadedcomment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['threadedcomments.ThreadedComment'], unique=True, primary_key=True)),
            ...
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, db_index=True, blank=True)),
            ('data', self.gf('jsonfield.fields.JSONField')(default={})),
        ))
        db.send_create_signal(u'discussion', ['DiscussionComment'])

        # Adding M2M table for field participants on 'DiscussionComment'
        m2m_table_name = db.shorten_name(u'discussion_discussioncomment_participants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('discussioncomment', models.ForeignKey(orm[u'discussion.discussioncomment'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['discussioncomment_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'DiscussionComment'
        db.delete_table(u'discussion_discussioncomment')

        # Removing M2M table for field participants on 'DiscussionComment'
        db.delete_table(db.shorten_name(u'discussion_discussioncomment_participants'))
    ...
    models = {
        ...
        u'discussion.discussioncomment': {
            'Meta': {'ordering': "('tree_path',)", 'object_name': 'DiscussionComment', '_ormbases': [u'threadedcomments.ThreadedComment']},
            'data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
