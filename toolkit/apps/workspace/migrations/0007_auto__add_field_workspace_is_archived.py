...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workspace.is_archived'
        db.add_column(u'workspace_workspace', 'is_archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workspace.is_archived'
        db.delete_column(u'workspace_workspace', 'is_archived')
