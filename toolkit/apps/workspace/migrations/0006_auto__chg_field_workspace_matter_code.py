...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Workspace.matter_code'
        db.alter_column(u'workspace_workspace', 'matter_code', self.gf('django.db.models.fields.SlugField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Workspace.matter_code'
        db.alter_column(u'workspace_workspace', 'matter_code', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
