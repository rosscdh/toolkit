...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:
            db.execute("ALTER TABLE auth_permission ALTER COLUMN name TYPE varchar(128);")
        except:
            # probably not postgres
            pass


    def backwards(self, orm):
        try:
            db.execute("ALTER TABLE auth_permission ALTER COLUMN name TYPE varchar(50);")
        except:
            # probably not postgres
            pass
