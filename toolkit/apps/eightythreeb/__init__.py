...
EIGHTYTHREEB_STATUS = get_namedtuple_choices('EIGHTYTHREEB_STATUS', (
    ...
    (7, 'datestamped_copy_recieved', 'Date stamped copy received by Customer'),  # attorney/customer - attorney/customer indicates they recieved the copy (may need to upload scan?)
