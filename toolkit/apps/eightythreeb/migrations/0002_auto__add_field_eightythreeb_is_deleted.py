...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EightyThreeB.is_deleted'
        db.add_column(u'eightythreeb_eightythreeb', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EightyThreeB.is_deleted'
        db.delete_column(u'eightythreeb_eightythreeb', 'is_deleted')
