...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EngagementLetter.is_deleted'
        db.add_column(u'engageletter_engagementletter', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EngagementLetter.is_deleted'
        db.delete_column(u'engageletter_engagementletter', 'is_deleted')
