...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EngagementLetter'
        db.create_table(u'engageletter_engagementletter', (
        ...
        db.send_create_signal(u'engageletter', ['EngagementLetter'])

        # Adding model 'Attachment'
        db.create_table(u'engageletter_attachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['engageletter.EngagementLetter'])),
            ('attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('body', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'engageletter', ['Attachment'])


    def backwards(self, orm):
        # Deleting model 'EngagementLetter'
        db.delete_table(u'engageletter_engagementletter')

        # Deleting model 'Attachment'
        db.delete_table(u'engageletter_attachment')
    ...
    models = {
        ...
        u'engageletter.attachment': {
            'Meta': {'object_name': 'Attachment'},
            'attachment': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
            'body': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'tool': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['engageletter.EngagementLetter']"})
        },
        u'engageletter.engagementletter': {
            'Meta': {'object_name': 'EngagementLetter'},
