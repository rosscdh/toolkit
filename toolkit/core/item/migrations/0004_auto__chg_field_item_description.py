...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'item_item', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Item.description'
        db.alter_column(u'item_item', 'description', self.gf('django.db.models.fields.TextField')(default=''))
