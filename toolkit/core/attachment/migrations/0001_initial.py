...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'attachment_revision', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True)),
            ('executed_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'attachment', ['Revision'])

        # Adding M2M table for field reviewers on 'Revision'
        m2m_table_name = db.shorten_name(u'attachment_revision_reviewers')
        ...
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_revision', models.ForeignKey(orm[u'attachment.revision'], null=False)),
            ('to_revision', models.ForeignKey(orm[u'attachment.revision'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_revision_id', 'to_revision_id'])


    def backwards(self, orm):
        # Deleting model 'Revision'
        db.delete_table(u'attachment_revision')
