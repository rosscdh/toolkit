...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Revision.is_current'
        db.add_column(u'attachment_revision', 'is_current',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Revision.is_current'
        db.delete_column(u'attachment_revision', 'is_current')
